        ...
        <Container>
            ...
            <Form >
                <Form.Group className="mb-3">
                    ...
                    <input type="number" id="XL" onChange={inputXL} style={{ width: "20%", margin: "0 auto" }} className="textcss"></input><br></br><br></br>
                    <Form.Label>XR : </Form.Label>
                    <input type="number" id="XR" onChange={inputXR} style={{ width: "20%", margin: "0 auto" }} className="textcss"></input><br></br><br></br>
                </Form.Group>
